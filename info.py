...
auth_channel = environ.get('AUTH_CHANNEL', '-1002217304333') # give your force subscribe channel id here else leave it blank
auth_grp = environ.get('AUTH_GROUP', '-1002239187727') # give your force subscribe group id here else leave it blank
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', '1410065122') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ALAS_NOW')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ALASSUPORT')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ALASSUPORT') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://pranthan-ba150e1b1d8e.herokuapp.com/")
